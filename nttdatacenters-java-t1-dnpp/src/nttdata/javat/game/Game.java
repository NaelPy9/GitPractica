...
public class Game {
	...
	public void launchAndStart() {
		...
		for (int k = 0; k < 1; k++) {
			...
			/*
			 * En el caso que la pelota toque choque contra los guiones será "propulsada"
			 * para arriba y el juego se reiniciara (se devuelve k a 0)
			 */
			if (gameOver) {
				k--;
			}
			/*
			 * Se escribe por pantalla que la partida ha acabado, se termina el for y
	 ...
	 * en ese caso, de manera aleatoria tomara el camino de la izquierda o de la
	 * derecha salvo que se encuentre al lado de una pared, que tomara el camino
	 * libre
	 * 
	 * @param objetos
	 * @param p
	...
	/**
	 * Dibuja las lineas comunes del mapa, las que no estan predefinidos y las que
	 * no actualizan valores de variables
	 * 
	 * @param objetos
	 * @param p
	 * @param i
	...
	/**
	 * Rellena el array aleatoriamente siguiendo los siguientes criterios: Cantidad
	 * de maximos true (obstaculo) por fila Si habia un onstaculo al lado
	 * 
	 * @param objects
	...
	/**
	 * Nos ayuda a elegir el tipo de mapa que queremos para el juego y devuelve el
	 * array con la distribucion de los obstaculos que estaran en el mapa
	 * 
	 * @return objetos
	 */
	...
	/**
	 * Dibuja la ultima linea que puede dibujar la pelota en el case que caiga en el
	 * agujero y actualiza el valor de la variable gameWin
	 * 
	 * @param width
	 * @param i
	 * @param gameWin
	...
	/**
	 * Dibuja la linea que determina si ganas o pierdes y actualiza el valor de la
	 * variable encargada de la continuacion del bucle
	 * 
	 * @param width
	 * @param i
	 * @param gameOver
